-- ============================================
-- Update register_user function to remove kakao_nickname requirement
-- Run this in Supabase SQL Editor
-- ============================================

-- Drop the old function with old parameters
DROP FUNCTION IF EXISTS register_user(TEXT, TEXT, TEXT, TEXT);

-- Create new register_user function without kakao_nickname parameter
