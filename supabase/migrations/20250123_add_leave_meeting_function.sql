-- ============================================
-- Add leave_meeting function
-- Allows participants to leave a meeting
-- ============================================

-- Create function to leave meeting
...
DECLARE
    ...
    v_result JSON;
BEGIN
    -- Check if user is a participant and get details
    SELECT
        EXISTS(
